...
public class TodayHotActivity extends BaseActivity implements StoryFlowEventHandler , OnRefreshListener , OnScrollListener {

    private static final String TAG = TodayHotActivity.class.getSimpleName();
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Constants.RELEASE_STORY_SUCCESS_ACTION)) {
                ...
                if (Utility.isNetworkAvailable(TodayHotActivity.this)) {
                    pageNum = 1;
                    mService.getTodayHotStory(TodayHotActivity.this, pageNum, pageSize);
                 } else {
                     Toast.makeText(TodayHotActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.today_hot_story);
        
        mPullToRefreshListView = (PullToRefreshListView) findViewById(R.id.today_listview);
        ...
        switch (eventId) {
            case Constants.STORY_INFO_LIST_SUCCESS:{
               ...
               /* if (pageNum >= recordSize / pageSize) {
                ...
                if (mData !=null && !mData.isEmpty()) {
                    mService.loadStoryItemInfo(TodayHotActivity.this, mData,
                            StoryFlowApp.getInstance().HorizontialPageNum,
                            StoryFlowApp.getInstance().HorizontialPageSize);
                } else {
                    Toast.makeText(TodayHotActivity.this, getString(R.string.data_is_null), Toast.LENGTH_SHORT).show();
                    dismissLoadingDialog();
                }
            ...
            case Constants.STORY_INFO_LIST_FAILED:{
                ...
                dismissLoadingDialog();
                Toast.makeText(TodayHotActivity.this, getString(R.string.no_network_connection_toast), Toast.LENGTH_SHORT).show();
            ...
            case Constants.STORY_PIC_LIST_SUCCESS:{
                ...
                StoryLogger.e(TAG, TAG+":mHashMap-->"+StoryFlowApp.getInstance().mHashMap.size());
        ...
        if (visibleItemCount > 0
            ...
            if (totalItemCount != mLastSavedTotalCount) {
                ...
                if (pageNum < totalPage) {
                    ...
                    pageNum++;
//                    showLoadingDialog();
                        Toast.makeText(TodayHotActivity.this, getString(R.string.next_page_loading), Toast.LENGTH_SHORT).show();
                        mService.getTodayHotStory(TodayHotActivity.this, pageNum, pageSize);
                } else {
                    if (recordSize%pageSize !=0 && pageNum ==totalPage) {
                        pageNum++;
//                        showLoadingDialog();
                           Toast.makeText(TodayHotActivity.this, getString(R.string.last_page_loading), Toast.LENGTH_SHORT).show();
                           mService.getTodayHotStory(TodayHotActivity.this, pageNum, pageSize);
                    }
                }
            }
