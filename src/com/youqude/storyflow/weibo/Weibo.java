...
public class Weibo {
    ...
    private boolean startSingleSignOn(Context activity, String applicationId,
            String[] permissions, int activityCode) {
        return false;
    }

    private void startDialogAuth(Context activity, String[] permissions) {
        ...
        dialog(activity, params, new WeiboDialogListener() {
            ...
            public void onComplete(Bundle values) {
                ...
                if (isSessionValid()) {
                    ...
                    Log.d("Weibo-authorize",System.currentTimeMillis()+"--->0");
                    Log.d("Weibo-authorize",new Date(mAccessToken.getExpiresIn())+"");
     ...
     *            授权结果监听器
     */
    public void authorize(Context activity, final WeiboDialogListener listener) {
    ...
    private void authorize(Context activity, String[] permissions, int activityCode,
            final WeiboDialogListener listener) {
        Utility.setAuthorization(new Oauth2AccessTokenHeader());
