...
public class ShowStorySelfLoveAdapter extends BaseAdapter{

    private static final String TAG = ShowStorySelfLoveAdapter.class.getSimpleName();
    ...
    public ShowStorySelfLoveAdapter(Context context, ImageCache mImageCache) {
    ...
    public void setData(ArrayList<LikeInfo> data){
        this.data = data;
    }
