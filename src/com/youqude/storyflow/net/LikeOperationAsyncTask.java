...
public class LikeOperationAsyncTask extends AsyncTask<Object[], Void, Boolean> {
    ...
    public LikeOperationAsyncTask(Context ctx, boolean isCancel, StoryFlowDescriptionAdapter adapter, AlbumInfo albumInfo ){
        this.mContext = ctx;
