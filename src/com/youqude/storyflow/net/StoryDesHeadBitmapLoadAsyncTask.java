...
public class StoryDesHeadBitmapLoadAsyncTask extends AsyncTask<Void, Void, Bitmap> {

    private static final String TAG = StoryDesHeadBitmapLoadAsyncTask.class.getSimpleName();
    ...
    public StoryDesHeadBitmapLoadAsyncTask(Context ctx, StoryFlowDescriptionAdapter adapter, int mStartIndex,
