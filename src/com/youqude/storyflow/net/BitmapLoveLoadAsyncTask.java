...
public class BitmapLoveLoadAsyncTask extends AsyncTask<Void, Void, Bitmap> {

    private static final String TAG = BitmapLoveLoadAsyncTask.class.getSimpleName();
    ...
    public BitmapLoveLoadAsyncTask(Context ctx, ShowStorySelfLoveAdapter adapter, int mStartIndex,
    ...
    protected Bitmap doInBackground(Void... params) {
        ...
        for (; mStartIndex < mEndIndex; mStartIndex++) {
            try {
                LikeInfo element = mAdapter.getItem(mStartIndex);
                if (element.picPath != null && !element.picPath.trim().equals("")) {
                    ...
                    element.picPath = element.picPath +".80x80x0.jpg";
...
//        adapter.notifyDataSetChanged();
    ...
    private Bitmap downloadImageThumbnail(LikeInfo element) {
        boolean flag = true;
        try {
