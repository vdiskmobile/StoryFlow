...
public class DeleteOperationAsyncTask extends AsyncTask<Object[], Void, Boolean> {
    ...
    public DeleteOperationAsyncTask(Context ctx, StoryFlowDescriptionAdapter adapter,
