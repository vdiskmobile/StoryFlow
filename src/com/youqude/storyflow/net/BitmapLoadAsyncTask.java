...
public class BitmapLoadAsyncTask extends AsyncTask<Void, Void, Bitmap> {
    ...
    private static final String TAG = BitmapLoadAsyncTask.class.getSimpleName();
    ...
    public BitmapLoadAsyncTask(Context ctx, ShowStoryPicAdapter adapter, int mStartIndex,
